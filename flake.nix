  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        ...
        packages.github-edit-binary = pkgs.stdenv.mkDerivation rec {
          pname = "github-edit";
          version = "0.1.3";

          src = pkgs.fetchurl {
            url = "https://github.com/tacogips/github-edit/releases/download/v${version}/github-edit-${pkgs.stdenv.hostPlatform.system}.tar.gz";
          ...
          installPhase = ''
            mkdir -p $out/bin
            cp github-edit-mcp $out/bin/
            cp github-edit-cli $out/bin/
            chmod +x $out/bin/*
          '';
        };
      }
